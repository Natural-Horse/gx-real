...
Self-contained execution-side adapter. The full world-frame anchoring mode
requires an odometry source; body-frame proportional mode works without one.
"""
...
class WaypointAdapterConfig:
    ...
    waypoint_yaw_tolerance_rad: float = math.radians(8.0)
